...
public class InventoryUnit : MonoBehaviour
{
    ...
    public void OnClicked()
    {
        ...
        {   // 장착 해제
            ...
            InventoryManager.instance.ShowInteractBox(this);
        }
    ...
    {
        InventoryManager.instance.HideInteractBox();
    }

    public void EquipItem()
    {
        if (isEquipUnit) return;

        if (curData.requireLevel > HeroManager.instance.selectedHero.level)
        {   // 레벨 제한으로 착용 불가
            return;
        }
